...
import { ImageBackground, Linking, FlatList, Modal, View, SafeAreaView, StyleSheet, Text, Dimensions, TouchableOpacity, ScrollView } from "react-native";
    ...
    if(chosen==0){
      return(
        <>
          ...
          <TouchableOpacity onPress={()=> navigation.navigate("Favorites")} style={{height: moderateScale(55), marginTop: moderateScale(10), flexDirection: 'row', borderRadius: moderateScale(5), alignItems: 'center', width: width-moderateScale(50), marginHorizontal: moderateScale(15), backgroundColor: 'white', elevation: 8, shadowColor: 'gray', shadowOpacity: 2, shadowOffset: {width: 1, height:1}, }}>
            <View style={{alignItems: 'center', justifyContent: 'center', backgroundColor: '#427AB3', borderRadius: 100, marginLeft: moderateScale(10), height: moderateScale(40), width: moderateScale(40)}}>
          ...
          <TouchableOpacity onPress={()=> out()} style={{height: moderateScale(55), marginTop: moderateScale(10), flexDirection: 'row', borderRadius: moderateScale(5), alignItems: 'center', width: width-moderateScale(50), marginHorizontal: moderateScale(15), backgroundColor: 'white', elevation: 8, shadowColor: 'gray', shadowOpacity: 2, shadowOffset: {width: 1, height:1}, }}>
            <View style={{alignItems: 'center', justifyContent: 'center', backgroundColor: '#427AB3', borderRadius: 100, marginLeft: moderateScale(10), height: moderateScale(40), width: moderateScale(40)}}>
      ...
      return(
        <>
          <TouchableOpacity onPress={()=> navigation.navigate("SubGuide")} style={{height: moderateScale(55), flexDirection: 'row', borderRadius: moderateScale(5), alignItems: 'center', width: width-moderateScale(50), marginHorizontal: moderateScale(15), backgroundColor: 'white', elevation: 8, shadowColor: 'gray', shadowOpacity: 2, shadowOffset: {width: 1, height:1}, }}>
            <View style={{alignItems: 'center', justifyContent: 'center', backgroundColor: '#427AB3', borderRadius: 100, marginLeft: moderateScale(10), height: moderateScale(40), width: moderateScale(40)}}>
          ...
          <TouchableOpacity onPress={async()=> await Linking.openURL('https://magusaudio.com/support')} style={{height: moderateScale(55), marginTop: moderateScale(10), flexDirection: 'row', borderRadius: moderateScale(5), alignItems: 'center', width: width-moderateScale(50), marginHorizontal: moderateScale(15), backgroundColor: 'white', elevation: 8, shadowColor: 'gray', shadowOpacity: 2, shadowOffset: {width: 1, height:1}, }}>
            <View style={{alignItems: 'center', justifyContent: 'center', backgroundColor: '#427AB3', borderRadius: 100, marginLeft: moderateScale(10), height: moderateScale(40), width: moderateScale(40)}}>
    ...
    if(logging==false){
      return(
        <>
            ...
            <ScrollView style={{height: height, marginTop: moderateScale(10), paddingTop: moderateScale(10), width: width-moderateScale(20)}}>
              {selection()}
            </ScrollView>
        </>
      )
      ...
      return(
        <>
            <View style={{justifyContent: 'space-between', backgroundColor: 'red', height: moderateScale(300), alignItems: 'center', borderRadius: moderateScale(5), width: width-moderateScale(50), marginHorizontal: moderateScale(15), elevation: 8, shadowColor: 'gray', shadowOpacity: 2, shadowOffset: {width: 1, height:1},}}>
              <View style={{flexDirection: 'row'}}>
  ...
  return(
    <ImageBackground source={require('../../assets/Me/me2/mebg.png')} style={styles.container}>
      <SafeAreaView style={{height: height, width: width}}>
        ...
        <View style={{width: width-moderateScale(20), height: height, marginTop:+moderateScale(145), marginHorizontal: moderateScale(10)}}>
        <View style={{width: moderateScale(120), height: moderateScale(120), marginTop: -moderateScale(70), backgroundColor: 'white', alignSelf: 'center', borderRadius: 500}}></View>
