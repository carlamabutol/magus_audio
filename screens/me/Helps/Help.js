...
import { Linking, StyleSheet, StatusBar, TextInput, FlatList, Modal, SafeAreaView, ImageBackground, Image, Text, TouchableOpacity, ScrollView, View, Dimensions } from "react-native";
...
const Help =({navigation})=>{
  ...
  const contactUs =async()=>{
    await Linking.openURL('https://magusaudio.com/support');
  }
  return(
    <ImageBackground source={require('../../../assets/Me/profilebg.png')} style={{width: width, height: height}}>
      ...
      <Modal
        ...
        visible={modal3}
      >
      <ImageBackground source={require('../../../assets/Me/profilebg.png')} style={{width: width1, height: height1}}>
          <SafeAreaView>
          <View style={{width: width, justifyContent: 'space-between', flexDirection: 'row'}}>
            ...
            <Text style={styles.mysubs}>Help</Text>
        ...
        <Image source={require('../../../assets/Me/helpme.png')} style={{width: scale(280), height: scale(200), alignSelf: 'center',}}/>
          ...
          <TouchableOpacity onPress={()=> navigation.navigate("Terms")} style={{flexDirection: 'row', marginTop: 30, left: 50, alignItems: 'center',}}>
          ...
          <TouchableOpacity onPress={()=> contactUs()} style={{flexDirection: 'row', paddingBottom: 20, marginTop: 30, left: 50, alignItems: 'center',}}>
            <View style={{width:scale(39), height: scale(39), backgroundColor: '#6A98CA', borderRadius: scale(30), justifyContent: 'center', alignItems: 'center', marginTop: -5, marginRight: 20}}>
              <Image source={{uri: 'https://cdn-icons-png.flaticon.com/512/8340/8340222.png'}} style={{height: scale(24), width: scale(20), tintColor: 'white'}}/>
            </View>
