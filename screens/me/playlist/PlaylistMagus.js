...
import { ScrollView, SafeAreaView, ImageBackground, Image, Text, TouchableOpacity, FlatList, View, Dimensions } from "react-native";
  ...
  return(
    <ImageBackground source={require('../../../assets/me/profilebg.png')} style={{width: width, height: height}}>
      ...
      <View style={{flexDirection: 'row', justifyContent: 'center', marginTop: 20}}>
        <TouchableOpacity onPress={()=> navigation.navigate("Playlist")}  style={{backgroundColor: 'rgba(4,157,217,1)', width: scale(100), height: scale(30), borderRadius: scale(12), flexDirection: 'row', justifyContent: 'center', marginRight: 10, shadowOpacity: 0.5, shadowOffset: {width: .5, height: .5}, shadowColor: 'black',}}>
          <Text style={{ color:'white', fontWeight: 'bold', fontSize: scale(11), justifyContent: 'center', alignSelf: 'center', textAlign: 'center',  paddingLeft: 15, paddingRight: 15, }}>By You</Text>
        </TouchableOpacity>
        <View style={{backgroundColor: 'white', width:  scale(100), height: scale(30), borderRadius: scale(12), flexDirection: 'row',justifyContent: 'center', marginRight: 10, shadowOpacity: 0.5, shadowOffset: {width: .5, height: .5}, shadowColor: 'black',}}>
          <Text style={{ color:'rgba(4,157,217,1)', fontWeight: 'bold', fontSize: scale(11), justifyContent: 'center', alignSelf: 'center', textAlign: 'center',  paddingLeft: 15, paddingRight: 15, }}>By Magus</Text>
        </View>
      </View>
        <ScrollView style={{marginTop: 20,}}>
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              <TouchableOpacity  onPress={()=> [global.playlist=item, global.myLocation="PlaylistMagus", navigation.navigate("TodayAllPlaylist")]} style={{borderRadius: 10, backgroundColor: 'white', flexDirection: 'row', marginBottom: 10, shadowOpacity: 0.5, shadowOffset: {width: .5, height: .5}, shadowColor: 'rgba(4,157,217,.8)', marginTop: 0}}>
