...
const styles = StyleSheet.create({
  ...
  touch: {
    backgroundColor: '#4C89C6', width: width-(100), borderRadius: 20, padding: moderateScale(10), flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: verticalScale(100)
  },
  imahe: {
    width: moderateScale(30), height: moderateScale(30)
  },
  email: {
    fontSize: scale(16), color: 'white', marginLeft: scale(20)
  },
  touch1: {
